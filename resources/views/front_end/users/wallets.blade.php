    ...
    <div class="container">
        <div class="topbar">
            <div class="logo">
                ...
                <h2 style="margin-top: -42px;margin-left: 61px;">{{Auth::guard('users')->user()->name}}</h2>
            </div>
            <div class="search">
            ...
            <div class="cards">
                <div class="card">
                    <div class="card-content">
                        <div class="number">{{$wallets->wallet_amount}}</div>
                        <div class="card-name">Wallets Amount</div>
                    </div>
                    <div class="icon-box">
