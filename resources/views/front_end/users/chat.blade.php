                        ...
                        <div class="col-md-12 col-12 card-stacked">
                            <div class="card shadow-line mb-3 chat chat-panel">
                                <div class="p-3 chat-header">
                                    ...
                                    <a href="#" class="btn btn-icon btn-light text-dark-75 active text-dark ml-2 p-3" onclick="window.history.go(-1); return false;">
                                        Back
                                    </a>
                                </div>
                                ...
                                <div id="chat_area"
                                    ...
                                    style="height:80vh;max-height:75vh;overflow:scroll;">
                                    <div class="w-100 p-3">
                                            ...
                                            <div class="right-chat-message fs-13 mb-2">
                                                <div class="mb-0 mr-3 pr-4">
                                                    <div class="d-flex flex-row">
                                                        <div class="pr-2">{!!$chat->chat_message!!}</div>
                                                        <div class="pr-4"> </div>
                                                    </div>
                                                </div>
                                                <div class="message-options dark">
                                                    <div class="message-time">
                                                        <div class="d-flex flex-row">
                                                            <div class="mr-2">{{$chat->message_time}}</div>
                                        ...
                                        <div class="left-chat-message fs-13 mb-2">
                                            <p class="mb-0 mr-3 pr-4">{!!$chat->chat_message!!}</p>
                                            <div class="message-options">
                                                <div class="message-time">{{$chat->message_time}}</div>
                                                <div class="message-arrow"><i
                                                        class="text-muted la la-angle-down fs-17"></i></div>
                                            </div>
                                        </div>
                                        ...
                                        @endforeach
                                         ...
                                         <span style="margin-left:50%;color:#fe870a;font-weight:600;bottom:0;">chat ended</span>
