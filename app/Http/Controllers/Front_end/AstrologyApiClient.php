...
class AstrologyApiClient  extends Controller
{
    private $userId = null;
    private $apiKey = null;
...
*/
    ...
    public function getKpPlanet($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        $resourceName = 'kp_planets';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getKpDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        $resourceName = 'kp_details';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
        ...
        public function getKpPlanetCusps($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        $resourceName = 'kp_house_cusps';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function getAntarVimDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$major_dasha)
    {
        $resourceName = 'sub_vdasha/'.$major_dasha;
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getPratyantarVimDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$major_dasha,$antar_dasha)
    {
        $resourceName = 'sub_sub_vdasha/'.$major_dasha.'/'.$antar_dasha;
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getSookshmaVimDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$major_dasha,$antar_dasha,$prantar_dasha)
    {
        $resourceName = 'sub_sub_sub_vdasha/'.$major_dasha.'/'.$antar_dasha.'/'.$prantar_dasha;
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getPlanetNature($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getHoroChartImage($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$chartId){
